...
$query5 = "INSERT INTO news_vars ( title, cookie, bgcolor, tborder, twidth, theight, tpadding, tspacing, howmany, ok, notok, tbg1, tbg2, tbg3, tbg4, tbg5, tbg6, fface, fcolor, fsize, fface2, fcolor2, fsize2 ) values('Current News','$cook','ff9944','0','100%','*','5','0','10','<img src=images/ok.gif border=0>','<img src=images/notok.gif border=0>','dddddd','ffffff','dddddd','ffffff','dddddd','ffffff','verdana','black','2','arial','black','1')";
